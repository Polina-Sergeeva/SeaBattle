...
public class BoardPanel extends JPanel {
    ...
    public BoardPanel(boolean active, ClientAction clientAction) {
        ...
        try {
            imgSea = ImageIO.read(new FileInputStream("C:/kr/client/gfx/sea1.jpg"));
            imgSplash = ImageIO.read(new FileInputStream("C:/kr/client/gfx/splash.jpg")); 
            imgFire = ImageIO.read(new FileInputStream("C:/kr/client/gfx/fire.jpg"));
            imgShipReveal = ImageIO.read(new FileInputStream("C:/kr/client/gfx/shipReveal.jpg"));
            imgShipProwH = ImageIO.read(new FileInputStream("C:/kr/client/gfx/ships.png"));
            imgShipProwV = ImageIO.read(new FileInputStream("C:/kr/client/gfx/ships.png"));
            imgShipBoardH = ImageIO.read(new FileInputStream("C:/kr/client/gfx/ships.png"));
            imgShipBoardV = ImageIO.read(new FileInputStream("C:/kr/client/gfx/ships.png"));
